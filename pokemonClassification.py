...
def cnn_model(model, training):
    if training:
        ...
        hist = model.fit_generator(train_generator, validation_data=val_generator, validation_steps=300, epochs=1,
        ...
        model_name = 'keras_poke_trained_model.h5'
...
def driver():
    ...
    model.load_weights('saved_models/keras_poke_trained_model.h5')
